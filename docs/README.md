...
<configuration>
  ...
  <entityFramework>
    <defaultConnectionFactory type="System.Data.Entity.Infrastructure.SqliteConnectionFactory, Link.EntityFramework.Sqlite">
  ...
  <connectionStrings>
    <add name="TestDataContext" connectionString="data source=Test.db;" providerName="System.Data.SQLite.EF6" />
  </connectionStrings>
